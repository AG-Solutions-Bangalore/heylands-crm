...
const EditBagType = ({ bagTypeId }) => {
  ...
  const handleSubmit = async () => {
    if (!formData.bagType_status.trim()) {
      toast({
        title: "Error",
        description: "Bag Type is required",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Bag Type updated successfully",
      });
      ...
      toast({
        title: "Error",
        description:
          error.response?.data?.message || "Failed to update bag type",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
        ...
        {isFetching ? (
          ...
          <div className="grid gap-4">
            <div className="space-y-2">
              <h4 className="font-medium leading-none">Edit bag type</h4>
              <p className="text-sm text-muted-foreground">
                Update bag type details
              </p>
            </div>
