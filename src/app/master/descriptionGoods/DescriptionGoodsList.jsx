...
const DescriptionGoodsList = () => {
  const {
    data: descriptionGoods,
    isLoading,
    isError,
    refetch,
  } = useQuery({
    queryKey: ["descriptionGoods"],
    queryFn: async () => {
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${BASE_URL}/api/panel-fetch-descriptionofGoods-list`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      return response.data.descriptionofGoods;
    },
  });
  ...
  const columns = [
    ...
    {
      accessorKey: "descriptionofGoods_status",
      header: "Status",
      cell: ({ row }) => {
        const status = row.getValue("descriptionofGoods_status");
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex flex-row">
            <EditDescriptionGoods descriptionId={descriptionId} />
          </div>
        );
      },
    },
      ...
      <div className="w-full p-4">
        ...
        <div className="flex items-center py-4">
          ...
          <div className="relative w-72">
            ...
            <Input
              placeholder="Search description of goods..."
              value={table.getState().globalFilter || ""}
...
export default DescriptionGoodsList;
