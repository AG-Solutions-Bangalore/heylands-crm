...
const EditCustomDescription = ({ customdescriptionId }) => {
  ...
  const [formData, setFormData] = useState({
    customdescription: "",
    customdescription_status: "Active",
  });
  ...
  const fetchStateData = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/api/panel-fetch-customdescription-by-id/${customdescriptionId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      const customDescriptionData = response?.data?.customdescription;
      setFormData({
        customdescription: customDescriptionData.customdescription || "",
        customdescription_status:
          customDescriptionData.customdescription_status || "Active",
      });
      setOriginalData({
        customdescription: customDescriptionData.customdescription || "",
        customdescription_status:
  ...
  const hasChanges =
    originalData &&
    (formData.customdescription !== originalData.customdescription ||
      formData.customdescription_status !==
        originalData.customdescription_status);
          ...
          <div className="grid gap-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Update custom description details
              </p>
            </div>
            <div className="grid gap-2">
              ...
              <div className="grid gap-1">
                ...
                <Select
                  value={formData.customdescription_status}
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      customdescription_status: value,
                    }))
                  }
                >
                  <SelectTrigger
...
export default EditCustomDescription;
